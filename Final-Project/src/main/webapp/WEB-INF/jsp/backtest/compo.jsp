...
<script type="text/javascript">
	...
	function addCondition(val) {
		if (document.getElementById(val)) {
			...
			newTag = "<input type='text' class='condi' id="+val+" name="+"back"+val+" readonly value="+val+">"
					+ "<button id="
					+ val
...
<script type="text/javascript">
	...
	function dateInput(n, m) {
		...
		$('#backStartDate').val(yyyy + '-' + addzero(mm) + '-' + addzero(dd));
		$('#backEndDate').val(
				t_yyyy + '-' + addzero(t_mm) + '-' + addzero(t_dd));
	}
						...
						<div class="row vertical-tab">
							<div class="col-md-6" style="width: 50%">
								<span class="font_20px" style="display: inline;"><b>내
										포트폴리오명</b></span><br> <input name="backTitle" type="text"
							...
							<div class="col-md-6" style="width: 50%">
								<span class="font_20px"><b>포트폴리오 설명</b></span><br> <input
									...
									class="titleInput" placeholder="포트 설명을 100자 이내로 작성해주세요" />
							</div>
						</div>
						<!-- 두번째, 기존 조건 설정  -->
						<hr>
						<div class="row vertical-tab">
							...
							<div class="col-md-3">
								<div class="card">
									...
									<div class="card-body">
										<input name="backStartAsset" id="backStartAsset"
											class="text_extrasmall" type="text"
							...
							<div class="col-md-2">
								<div class="card">
									...
									<div class="card-body">
										<input name="backFeeRate" class="text_extrasmall" type="text"
											value="0.15"><span class="top">%</span>
									</div>
								</div>
							</div>
							<div class="col-md-2">
								<div class="card">
									...
									<div class="card-body">
										<input name="backTaxRate" class="text_extrasmall" type="text"
											value="0.3"><span class="top">%</span>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row vertical-tab">
							...
							<div class="col-md-3">
								<div class="card">
									...
									<div class="card-body">
										<select name="backStockCnt" id="slct_stockCnt"
											class="slct_newport">
							...
							<div class="col-md-3">
								<div class="card">
									...
									<div class="card-body">
										<select name="backRebalCycle" id="AARebalCycle"
											class="slct_newport">
							...
							<div class="col-md-3">
								<div class="card">
									...
									<div class="card-body">
										<select name="backInvestRate" id="slct_investRate"
											class="slct_newport">
							...
							<div class="col-md-3">
								<div class="card">
									...
									<div class="card-body">
										<input name="backSlippage" class="text_extrasmall" type="text"
											value="0.003"><span class="top">%</span>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row vertical-tab">
							...
							<div class="col-md-2">
								<div class="card">
									...
									<div class="card-body">
										<select name="backMarket" id="slct_market"
											class="slct_newport">
									...
									<div class="card-body container card-selection">
										...
										<div class="col-md-3"
											...
											<span class="top">우선주 종목</span><br> <input type="radio"
												...
												type="radio" name="backPreferred" id="preferredOn"
							...
							<div class="col-md-4">
								<div class="card">
									...
									<div class="card-body">
										...
										</select> <input name="backTransAmt" class="text_extrasmall"
											type="text" id="stockVolume"
											onkeyup="numberWithCommas(this.value, this.id)"><span
											class="top">만원</span>
									</div>
								</div>
								...
								<div class="card">
									...
									<div class="card-body">
										<span class="top" style="margin-right: 10px;">시가 총액</span> <select
											...
											<option value="lte">≤</option>
											<option value="gte">≥</option>
										</select> <input name="backMarketCap" class="text_extrasmall"
											id="stockSize" type="text"
											onkeyup="numberWithCommas(this.value, this.id)"><span
						...
						<div class="row vertical-tab">
									...
									<div class="card-body container">
										...
										<div class="col-md-6" style="float: left">
											<span class="top" style="background-color: #e1f1f8">매도
												금액 : </span> <select name="backSellPrice" id="AARebalCycle"
												class="slct_newport">
												<option value="open" selected="selected">당일 시초가</option>
												<option value="avg">당일 평균가</option>
												<option value="end">당일 종가</option>
							...
							<div class="col-md-3">
								<div class="card">
									...
									<div class="card-body">
										<select id="slct_minPrice" name="backMinPriceV"
											...
											<option value="lte">≤</option>
											<option value="gte">≥</option>
										</select> <input name="backMinPrice" class="text_extrasmall"
											type="text" style="width: 85px;" id="min_price"
											onkeyup="numberWithCommas(this.value, this.id)"> <span
											class="top">원</span>
									</div>
								</div>
							...
							<div class="col-md-3">
								<div class="card">
									...
									<div class="card-body">
										...
										</select> <input name="backCapRate" class="text_extrasmall" type="text"
